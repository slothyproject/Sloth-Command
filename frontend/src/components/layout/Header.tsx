...
export function Header({ onOpenMobileNav }: { onOpenMobileNav: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-line/80 bg-[rgba(13,21,32,0.85)] backdrop-blur-chrome">
      <div className="mx-auto flex w-full max-w-[1500px] items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <div className="space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="dashboard-chip rounded-full px-3 py-1 text-[11px] font-mono uppercase tracking-[0.18em]">sloth dojo command center</span>
            <span className="rounded-full border border-sloth-gold/20 bg-sloth-gold/10 px-3 py-1 text-[11px] font-mono uppercase tracking-[0.16em] text-sloth-gold">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="font-display text-xl font-semibold text-text-0 sm:text-2xl">Sloth Dojo Dashboard</h1>
              <p className="text-sm text-text-2">Stay calm and protected. Command your realm with zen-like focus.</p>
            </div>
          </div>
        </div>
