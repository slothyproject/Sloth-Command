...
type DiscordBotRecord = Awaited<ReturnType<typeof prisma.discordBot.findUnique>>;
...
): Promise<NonNullable<DiscordBotRecord>> {
 ...
 */
async function generateBotFiles(bot: NonNullable<DiscordBotRecord>): Promise<void> {
 ...
 */
function generateBotCode(bot: NonNullable<DiscordBotRecord>): string {
  return `/**
 ...
 */
function generateCommandsCode(bot: NonNullable<DiscordBotRecord>): string {
  return `/**
 * Command Handlers
 * Bot: ${bot.name}
 */
 ...
 * Get all bots
 */
export async function getAllBots(): Promise<Array<NonNullable<DiscordBotRecord>>> {
